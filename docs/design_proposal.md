...
* wytrenowanie wybranych modeli klasyfikacyjnych na przygotowanych danych wejściowych,
...
* Implementacja pętli trenującej dla klasyfikatorów audio.
* Uruchomienie pierwszej metody atrybucji na poprawnie działającym modelu.
...
* Implementacja skryptu do kaskadowej randomizacji wag modelu.
...
* **Trenowanie modeli:** Rozpoczęcie procesu uczenia modeli na pozmienianych etykietach.
...
* Przygotowanie instrukcji użytkowania oraz dokumentacji końcowej.
